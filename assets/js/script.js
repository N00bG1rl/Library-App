...
function addItem() {
 /*  Complete and remove icons in SVG format */
  ...
  if (title) {
    ...
    h3.innerText = document.getElementById('title').value;

    let span = document.createElement('span');
    span.innerHTML = '<strong>By: </strong>' + document.getElementById('author').value;

    let h5 = document.createElement('h5');
    h5.innerHTML = document.getElementById('pages').value + ' pages';
